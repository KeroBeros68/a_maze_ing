...
class ConfigModel(BaseSettings):
    WIDTH: int = Field(..., ge=0, le=105, description="Width of the maze")
    HEIGHT: int = Field(..., ge=0, le=44, description="Height of the maze")
    ...
    VIEW: int = Field(default=1, ge=1, le=3, description="View mode")
