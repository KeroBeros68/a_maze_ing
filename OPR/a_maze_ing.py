...
if config.VIEW == 2 or config.VIEW == 3:
    sys.stdout.write("\33[2J\33[?25l")
    sys.stdout.flush()
...
if config.VIEW == 1:
    ...
    print("\33[0m")
    print("\nSEED =", config.SEED)
elif config.VIEW == 2 or config.VIEW == 3:
    view = TermView(config, maze)
    view.display_maze()
    sys.stdout.write("\n\33[?25h\33[0m\n")
